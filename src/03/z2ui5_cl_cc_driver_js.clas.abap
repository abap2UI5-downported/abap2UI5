...
*      result = mo_view->_cc_plain_xml( js )->get_parent( )->_cc_plain_xml( css ).
    ...
    METHOD set_driver_configs.
      ...
      DATA ls_config LIKE steps_config.
      DATA ls_highlight_config LIKE highlight_config.
      DATA ls_highlight_driver_config LIKE highlight_driver_config.
      DATA drive_js TYPE string.
      ...
      ls_config = steps_config.
      
      ls_highlight_config = highlight_config.
      
      ls_highlight_driver_config = highlight_driver_config.

      "load driver object from window object
      
      drive_js = `const driver = window.driver.js.driver;` && |\n| &&
