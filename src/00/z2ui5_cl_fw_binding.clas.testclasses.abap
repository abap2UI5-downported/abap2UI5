...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  ...
  METHOD test_dissolve_init.
    ...
    READ TABLE lt_dissolve INTO temp18 WITH KEY name = `MO_APP`.
    IF sy-subrc = 0.
      temp17 = temp18.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp20 WITH KEY name = `MR_STRUC`.
    IF sy-subrc = 0.
      temp19 = temp20.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp22 WITH KEY name = `MR_VALUE`.
    IF sy-subrc = 0.
      temp21 = temp22.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp24 WITH KEY name = `MS_STRUC`.
    IF sy-subrc = 0.
      temp23 = temp24.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp26 WITH KEY name = `MV_VALUE`.
    IF sy-subrc = 0.
      temp25 = temp26.
    ENDIF.
  ...
  METHOD test_dissolve_dref.
    ...
    READ TABLE lt_dissolve INTO temp28 WITH KEY name = `MO_APP`.
    IF sy-subrc = 0.
      temp27 = temp28.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp30 WITH KEY name = `MR_STRUC->*`.
    IF sy-subrc = 0.
      temp29 = temp30.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp32 WITH KEY name = `MR_VALUE->*`.
    IF sy-subrc = 0.
      temp31 = temp32.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp34 WITH KEY name = `MS_STRUC`.
    IF sy-subrc = 0.
      temp33 = temp34.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp36 WITH KEY name = `MV_VALUE`.
    IF sy-subrc = 0.
      temp35 = temp36.
    ENDIF.
  ...
  METHOD test_dissolve_oref.
    ...
    READ TABLE lt_dissolve INTO temp38 WITH KEY name = `MO_APP->MV_VALUE`.
    IF sy-subrc = 0.
      temp37 = temp38.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp40 WITH KEY name = `MO_APP->MR_STRUC`.
    IF sy-subrc = 0.
      temp39 = temp40.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp42 WITH KEY name = `MO_APP->MR_VALUE`.
    IF sy-subrc = 0.
      temp41 = temp42.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp44 WITH KEY name = `MO_APP->MS_STRUC`.
    IF sy-subrc = 0.
      temp43 = temp44.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp46 WITH KEY name = `MR_STRUC`.
    IF sy-subrc = 0.
      temp45 = temp46.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp48 WITH KEY name = `MR_VALUE`.
    IF sy-subrc = 0.
      temp47 = temp48.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp50 WITH KEY name = `MS_STRUC`.
    IF sy-subrc = 0.
      temp49 = temp50.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp52 WITH KEY name = `MV_VALUE`.
    IF sy-subrc = 0.
      temp51 = temp52.
    ENDIF.
  ...
  METHOD test_dissolve_struc.
    ...
    READ TABLE lt_dissolve INTO temp54 WITH KEY name = `MO_APP`.
    IF sy-subrc = 0.
      temp53 = temp54.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp56 WITH KEY name = `MR_STRUC`.
    IF sy-subrc = 0.
      temp55 = temp56.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp58 WITH KEY name = `MS_STRUC-INPUT`.
    IF sy-subrc = 0.
      temp57 = temp58.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp60 WITH KEY name = `MS_STRUC-S_02-INPUT`.
    IF sy-subrc = 0.
      temp59 = temp60.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp62 WITH KEY name = `MS_STRUC-S_02-S_03-S_04-INPUT`.
    IF sy-subrc = 0.
      temp61 = temp62.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp64 WITH KEY name = `MR_VALUE`.
    IF sy-subrc = 0.
      temp63 = temp64.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp66 WITH KEY name = `MS_STRUC`.
    IF sy-subrc = 0.
      temp65 = temp66.
    ENDIF.
    ...
    READ TABLE lt_dissolve INTO temp68 WITH KEY name = `MV_VALUE`.
    IF sy-subrc = 0.
      temp67 = temp68.
    ENDIF.
...
DATA lv_result TYPE string.
    ...
    CLEAR temp71.
    temp71-name = `MS_STRUC-S_02-S_03-S_04-INPUT`.
...
DATA lv_result TYPE string.
    ...
    CLEAR temp79.
    temp79-name = `MO_APP->MS_STRUC-INPUT`.
