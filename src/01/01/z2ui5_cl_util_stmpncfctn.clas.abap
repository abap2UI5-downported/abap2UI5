...
CLASS z2ui5_cl_util_stmpncfctn IMPLEMENTATION.
  ...
  METHOD rtti_get_data_element_texts.
    ...
    TRY.
        ...
        temp1 ?= cl_abap_structdescr=>describe_by_name( 'DFIES' ).
        ...
        temp2 ?= cl_abap_elemdescr=>describe_by_name( data_element_name ).
