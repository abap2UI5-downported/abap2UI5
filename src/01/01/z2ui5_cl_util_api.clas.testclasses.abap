...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_url_param_get_tab.
    ...
    DATA lt_param TYPE z2ui5_if_types=>ty_t_name_value.
    DATA temp62 LIKE LINE OF lt_param.
    ...
    temp63 = sy-tabix.
    READ TABLE lt_param WITH KEY n = `sap-client` INTO temp62.
    sy-tabix = temp63.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
    ...
    temp65 = sy-tabix.
    READ TABLE lt_param WITH KEY n = `app_start` INTO temp64.
    sy-tabix = temp65.
    IF sy-subrc <> 0.
      ASSERT 1 = 0.
    ENDIF.
...
DATA BEGIN OF ms_struc2.INCLUDE TYPE ty_struc.INCLUDE TYPE ty_struc_incl.DATA END OF ms_struc2.
    ...
    DATA temp81 TYPE REF TO cl_abap_datadescr.
    ...
    lt_attri = z2ui5_cl_util=>rtti_get_t_attri_by_include( type = temp81 attri = `` ).
