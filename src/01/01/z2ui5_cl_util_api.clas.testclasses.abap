...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_url_param_get_tab.
    ...
    temp61 = sy-tabix.
    READ TABLE lt_param WITH KEY n = `sap-client` INTO temp60.
    sy-tabix = temp61.
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE cx_sy_itab_line_not_found.
    ENDIF.
    ...
    temp63 = sy-tabix.
    READ TABLE lt_param WITH KEY n = `app_start` INTO temp62.
    sy-tabix = temp63.
    IF sy-subrc <> 0.
      RAISE EXCEPTION TYPE cx_sy_itab_line_not_found.
    ENDIF.
