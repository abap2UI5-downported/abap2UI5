...
CLASS Z2UI5_CL_FW_APP IMPLEMENTATION.
  ...
  METHOD app_next_factory.
    ...
    DATA temp1 TYPE string.
        DATA ls_db_next TYPE z2ui5_cl_fw_draft=>ty_s_db.
    IF app->id_draft IS INITIAL.
      temp1 = z2ui5_cl_util_func=>uuid_get_c32( ).
    ELSE.
      temp1 = app->id_draft.
    ENDIF.
    app->id_draft = temp1.
    ...
    TRY.
        ...
        ls_db_next = z2ui5_cl_fw_draft=>load_app( app->id_draft ).
  ...
  METHOD factory_app_leave.
    ...
    TRY.
        ...
        ls_draft = z2ui5_cl_fw_draft=>read( id = result->ms_db-id check_load_app = abap_false ).
  ...
  METHOD factory_by_frontend.
    DATA temp2 TYPE REF TO z2ui5_cl_fw_http_mapper.
    ...
    CREATE OBJECT temp2 TYPE z2ui5_cl_fw_http_mapper.
    temp2->model_front_to_back(
