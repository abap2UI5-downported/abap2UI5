...
CLASS z2ui5_cl_fw_app IMPLEMENTATION.
  ...
  METHOD attri_get_by_data.
    ...
    DATA lr_data LIKE REF TO val.
          FIELD-SYMBOLS <temp1> TYPE z2ui5_if_fw_types=>ty_s_attri.
      DATA temp2 LIKE REF TO mt_attri.
DATA lo_dissolver TYPE REF TO z2ui5_cl_fw_hlp_dissolver.
    ...
    DO 3 TIMES.
      ...
      TRY.
          ...
          READ TABLE mt_attri WITH KEY r_ref = lr_data ASSIGNING <temp1>.
IF sy-subrc <> 0.
  RAISE EXCEPTION TYPE cx_sy_itab_line_not_found.
ENDIF.
GET REFERENCE OF <temp1> INTO result.
          RETURN.
        CATCH cx_root.
      ENDTRY.
...
CREATE OBJECT lo_dissolver TYPE z2ui5_cl_fw_hlp_dissolver EXPORTING attri = temp2 app = mo_app.
      lo_dissolver->main( ).
  ...
  METHOD db_load.
    ...
    DATA lo_db TYPE REF TO z2ui5_cl_fw_hlp_db.
    DATA ls_db TYPE z2ui5_t_fw_01.
    CREATE OBJECT lo_db TYPE z2ui5_cl_fw_hlp_db.
...
DATA lo_dissolver TYPE REF TO z2ui5_cl_fw_hlp_dissolver.
    DATA lo_json_mapper TYPE REF TO z2ui5_cl_fw_hlp_json_mapper.
    DATA temp5 LIKE REF TO mt_attri.
    GET REFERENCE OF mt_attri INTO temp4.

CREATE OBJECT lo_dissolver TYPE z2ui5_cl_fw_hlp_dissolver EXPORTING attri = temp4 app = mo_app.
    lo_dissolver->set_attri_ready( ).

    
    CREATE OBJECT lo_json_mapper TYPE z2ui5_cl_fw_hlp_json_mapper.
...
lo_json_mapper->model_client_to_server(
  ...
  METHOD all_xml_parse.
    DATA temp6 LIKE LINE OF result->mt_attri.
