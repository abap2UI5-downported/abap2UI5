...
CLASS ltcl_unit_test IMPLEMENTATION.
  ...
  METHOD test_req_begin_fw_start.
    ...
    DATA temp7 TYPE REF TO z2ui5_cl_fw_app_startup.
    DATA lo_app_fw LIKE temp7.
  ...
  METHOD test_req_begin_app_start.
    ...
    DATA lv_body TYPE string.
    DATA lo_handler TYPE REF TO z2ui5_cl_fw_controller.
    DATA temp8 TYPE REF TO z2ui5_cl_app_hello_world.
    DATA lo_app_fw LIKE temp8.
