...
CLASS ltcl_test_bind IMPLEMENTATION.
  ...
  METHOD test_one_way_w_x_error.
    ...
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
        DATA temp16 LIKE REF TO lo_app_client->xx.
    ...
    TRY.
        ...
        GET REFERENCE OF lo_app_client->xx INTO temp16.
lo_bind->main(
            val  = temp16
...
CLASS ltcl_test_main_structure IMPLEMENTATION.
  ...
  METHOD test_one_way_lev1.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp23 LIKE REF TO lo_test_app->ms_struc-input.
DATA lv_result TYPE string.
    DATA temp24 LIKE REF TO lo_test_app->ms_struc-input.
DATA temp1 TYPE z2ui5_if_core_types=>ty_s_bind_config.
    ...
    GET REFERENCE OF lo_test_app->ms_struc-input INTO temp23.
...
lv_result = lo_bind->main(
    ...
    GET REFERENCE OF lo_test_app->ms_struc-input INTO temp24.
...
lv_result = lo_bind->main(
  ...
  METHOD test_one_way_lev2.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp25 LIKE REF TO lo_test_app->ms_struc-s_02-input.
DATA lv_result TYPE string.
    CREATE OBJECT lo_test_app TYPE ltcl_test_main_structure.
    ...
    GET REFERENCE OF lo_test_app->ms_struc-s_02-input INTO temp25.
...
lv_result = lo_bind->main(
  ...
  METHOD test_one_way_lev3.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp26 LIKE REF TO lo_test_app->ms_struc-s_02-s_03-input.
DATA lv_result TYPE string.
    CREATE OBJECT lo_test_app TYPE ltcl_test_main_structure.
    ...
    GET REFERENCE OF lo_test_app->ms_struc-s_02-s_03-input INTO temp26.
...
lv_result = lo_bind->main(
  ...
  METHOD test_one_way_lev4_long_name.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp27 LIKE REF TO lo_test_app->ms_struc-s_02-s_03-s_04-input.
DATA lv_result TYPE string.
    CREATE OBJECT lo_test_app TYPE ltcl_test_main_structure.
    ...
    GET REFERENCE OF lo_test_app->ms_struc-s_02-s_03-s_04-input INTO temp27.
...
CLASS ltcl_test_main_object IMPLEMENTATION.
  ...
  METHOD test_one_way_value.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp28 LIKE REF TO lo_test_app->mo_obj->mv_value.
DATA lv_result TYPE string.
    ...
    GET REFERENCE OF lo_test_app->mo_obj->mv_value INTO temp28.
...
lv_result = lo_bind->main(
  ...
  METHOD test_one_way_struc.
    ...
    DATA lo_app TYPE REF TO z2ui5_cl_core_app.
    DATA lo_bind TYPE REF TO z2ui5_cl_core_bind_srv.
    DATA temp29 LIKE REF TO lo_test_app->mo_obj->ms_struc-input.
DATA lv_result TYPE string.
    CREATE OBJECT lo_test_app TYPE ltcl_test_main_object.
    CREATE OBJECT lo_test_app->mo_obj.
    ...
    GET REFERENCE OF lo_test_app->mo_obj->ms_struc-input INTO temp29.
