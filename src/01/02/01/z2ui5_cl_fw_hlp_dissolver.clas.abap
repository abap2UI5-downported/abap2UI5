...
CLASS z2ui5_cl_fw_hlp_dissolver IMPLEMENTATION.
  ...
  METHOD dissolve_dref.
    ...
    DATA lr_bind LIKE REF TO temp1.
      DATA lt_attri TYPE z2ui5_if_fw_types=>ty_t_attri.
  ...
  METHOD get_t_attri_by_dref.
    ...
    DATA temp5 TYPE z2ui5_if_fw_types=>ty_s_attri.
  ...
  METHOD get_t_attri_by_include.
    ...
    DATA lr_comp LIKE REF TO temp7.
      ...
      DATA temp8 TYPE z2ui5_if_fw_types=>ty_s_attri.
  ...
  METHOD get_t_attri_by_oref.
    ...
    DATA ls_attri2 LIKE LINE OF lt_attri2.
      DATA temp10 TYPE z2ui5_if_fw_types=>ty_s_attri.
    ...
    DATA lr_comp LIKE REF TO temp11.
      DATA lv_element TYPE string.
        ...
        DATA lv_type_name TYPE string.
          DATA temp12 TYPE z2ui5_if_fw_types=>ty_s_attri.
          DATA ls_attri LIKE temp12.
          DATA temp13 TYPE z2ui5_if_fw_types=>ty_s_attri.
    lv_name = `MO_APP->` && val.
