...
CLASS z2ui5_cl_core_ui5_app IMPLEMENTATION.
  ...
  METHOD index_html.
    ...
    DATA temp8 TYPE REF TO z2ui5_cl_core_ui5_app.
    DATA temp9 TYPE REF TO z2ui5_cl_core_ui5_app.
    DATA temp10 TYPE REF TO z2ui5_cl_core_ui5_app.
    DATA temp2 LIKE LINE OF is_config-t_add_config.
    ...
    IF is_config-styles_css IS INITIAL.
      ...
      lv_style_css = temp3->css_style_css( ).
    ELSE.
    ...
    CREATE OBJECT temp8 TYPE z2ui5_cl_core_ui5_app.
    ...
    result = `<!DOCTYPE html>` && |\n| &&
             ...
             `      "z2ui5/manifest.json": '` && temp1->manifest_json( ) && ` ',` && |\n| &&
             `      "z2ui5/Component.js": function(){` && temp4->component_js( ) && is_config-custom_js && ` },` && |\n| &&
             `      "z2ui5/css/style.css": '` && lv_style_css && `',` && |\n| &&
             `      "z2ui5/model/models.js": function(){` && temp5->model_models_js( ) && `},` && |\n| &&
             `      "z2ui5/i18n/i18n.properties": '` && temp6->i18n_i18n_properties( ) && `' ,` && |\n| &&
             `      "z2ui5/view/App.view.xml": '` && temp7->view_app_xml( )  && `' ,` && |\n| &&
             `      "z2ui5/controller/App.controller.js": function(){` && temp8->controller_app_js( ) && `},` && |\n| &&
