...
CLASS z2ui5_cl_pop_transport IMPLEMENTATION.
  ...
  METHOD on_event.
        DATA line TYPE z2ui5_cl_pop_transport=>ty_s_data.
...
*    ENDLOOP.
  ...
  METHOD get_tr_onprem.
    ...
    DATA table_name TYPE c LENGTH 4.
        ...
        DATA data TYPE REF TO z2ui5_cl_pop_transport=>ty_s_data.
  ...
  METHOD set_e071k.
    ...
    t_comp = z2ui5_cl_util_api=>rtti_get_t_attri_by_table_name( 'E071K' ).
    ...
    dfies = z2ui5_cl_util_api=>rtti_get_t_dfies_by_table_name( iv_tabname ).
